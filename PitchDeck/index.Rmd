...
The averaged approach to the neural networks is capable of perfroming better than the linear model, but not always and rarely by very much.  The regularization pentalty seems to work will in that the performance on the hold-out data indicates reasonable generalization.
